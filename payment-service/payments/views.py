...
from .throttles import PaymentCreationRateThrottle, PaymentStatusRateThrottle, RefundRateThrottle
...
class CreatePaymentView(APIView):
    ...
    throttle_classes = [PaymentCreationRateThrottle]
...
class RefundPaymentView(APIView):
    ...
    """
    authentication_classes = [PaymentServiceAuthentication]
    throttle_classes = [RefundRateThrottle]
    def post(self, request):
...
class ReconciliationView(APIView):
    ...
    Triggers reconciliation for stuck payments.
    """
    authentication_classes = [PaymentServiceAuthentication]
